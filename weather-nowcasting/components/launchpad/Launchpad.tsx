...
// ponytail: shortcuts live as static defaults + bookmark-derived; no separate store slice needed
...
export const Launchpad: React.FC = () => {
  ...
  const handleAddShortcut = (e: React.FormEvent) => {
    ...
    setShortcuts((prev) => [
      ...prev,
      { id: `sc-${Date.now()}`, title: newTitle.trim(), url: formattedUrl, icon: 'Globe' },
    ]);
